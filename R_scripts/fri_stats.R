...
#if includes FRI_rest (e.g. restoration)
...
p <- ggplot(final10) +  geom_bar(aes(x = reorder(EVT_NAME, annualALL_un), y = annualALL_un), stat = 'identity') + scale_y_continuous(limits=c(0,200000))
p + coord_flip()